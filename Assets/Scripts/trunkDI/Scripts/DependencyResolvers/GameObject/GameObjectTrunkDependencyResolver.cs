namespace trunkDI.Scripts.DependencyResolvers.GameObject
{
    using System.Collections.Generic;
    using Resolver;
    using UnityEngine;

    public class GameObjectTrunkDependencyResolver : TrunkDependencyResolver
    {
        #region Resolving
        protected override void GetTargetObjects()
        {
            ...
            var components = TrunkHelpers.GetAllComponents(childrenList);
