namespace trunkDI.Scripts.Example
{
    ...
    public class TestNestedModuleInjection 
    {
        ...
        [TrunkAttributes.Injectable] private ViewManager usedViewManager;
        [TrunkAttributes.NestedInjectable] private NestedInNested nested = new NestedInNested();
        [TrunkAttributes.NestedInjectable(ForceInitialization = true)] private NestedInNested nestedUninitialized;
        #endregion
        #region Public API
        public void Alert()
        {
    ...
    {
        #region Private Variables
        [TrunkAttributes.Injectable] private MessageData messageData;
        [TrunkAttributes.NestedInjectable] private Nested3rdLevelTest deeperLevelTest = new Nested3rdLevelTest();
        #endregion
        #region Public API
