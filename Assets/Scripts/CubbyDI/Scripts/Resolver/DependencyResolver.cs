namespace CubbyDI.Scripts.Resolver
{
    using System;
    ...
    public abstract class DependencyResolver : SerializedMonoBehaviour
    {
        ...
        [HideLabel]
        protected List<CubbyInstaller> declaredInstallers = new List<CubbyInstaller>();
        #endregion
        ...
        protected virtual void ResolveNested(ref object parentInstance)
        {
            ...
            {
                var nestedInjectAttribute = fieldInfo.GetCustomAttribute<CubbyAttributes.NestedInjectable>();
        ...
        protected virtual void ResolveDependencies(ref object instanceObject)
        {
            ...
            {
                var injectAttribute = fieldInfo.GetCustomAttribute(typeof(CubbyAttributes.Injectable), true);
        ...
        protected virtual void Install(List<CubbyInstaller> installers)
        {
