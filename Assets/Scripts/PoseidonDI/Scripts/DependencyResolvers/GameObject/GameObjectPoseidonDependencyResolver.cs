namespace PoseidonDI.Scripts.DependencyResolvers.GameObject
{
    using System.Collections.Generic;
    using Resolver;
    using UnityEngine;

    public class GameObjectPoseidonDependencyResolver : PoseidonDependencyResolver
    {
        #region Resolving
        protected override void GetTargetObjects()
        {
            ...
            var components = PoseidonHelpers.GetAllComponents(childrenList);
